  ...
  return (
    <>
      ...
      <div className="text-center pt-6 pb-6 bg-white select-none">
        <span className="text-[10px] md:text-xs uppercase tracking-[0.35em] text-[#d60f36] font-semibold block mb-2">
          Don't Miss Out
        </span>
        <h2 className="text-4xl md:text-5xl font-serif font-normal tracking-tight text-stone-900 uppercase">
          Trending <span className="font-sans font-black tracking-tighter text-stone-950">Now</span>
        </h2>
      </div>
          ...
          <div className="w-full flex items-center justify-center">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 text-left select-none z-10">
                <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-white/70 mb-1">
                  Limited Edition
                </span>
                <h3 className="text-4xl md:text-5xl font-serif font-light text-white leading-tight tracking-tight mb-2">
                  Summer <br />
                  <span className="font-sans font-black uppercase tracking-wide text-white">Sale</span>
                </h3>
                <p className="text-lg md:text-xl font-sans font-extrabold uppercase tracking-widest text-white mt-1">
                  Up To 50% Off
                </p>
                
                {/* Clean Inverting Button Bar */}
                <div className="mt-6 inline-flex items-center justify-center bg-white text-stone-950 font-sans font-bold text-xs uppercase tracking-widest px-8 py-3.5 shadow-md transition-all duration-300 group-hover:bg-[#d60f36] group-hover:text-white w-fit">
                  Buy Now
                </div>
              </div>
            </motion.div>
          ...
          <div className="w-full flex flex-col justify-start gap-6">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-6 pointer-events-none select-none z-10 transition-all duration-400 group-hover:opacity-0 group-hover:translate-y-1">
                <div className="self-start bg-[#d60f36] text-white text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded">
                  Teaser Drop
                </div>
                ...
                <div className="text-left space-y-0.5">
                  ...
                  <h4 className="text-xl font-black uppercase tracking-tight text-white leading-tight">
                    Coming Soon <br />
                    <span className="text-stone-950 bg-white px-2 py-0.5 inline-block mt-1.5 rounded font-bold text-xs">
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 select-none z-10">
                <div>
                  <h5 className="text-sm font-bold uppercase tracking-wider text-white">Classic Shirt Line</h5>
                  <p className="text-xs text-white/70 font-medium">Upto 30% Off Sale</p>
                </div>
                <div className="w-fit bg-white text-stone-950 font-sans font-bold text-[10px] uppercase tracking-widest px-5 py-2.5 transition-colors duration-300 group-hover:bg-[#d60f36] group-hover:text-white">
                  Buy Now
                </div>
              </div>
            </motion.div>
